...
###honestly i just wanted to preserve the original lambda script so i made a new one with changes
def Create_Lambda(function_name):
    ...
    response = lambda_client.create_function(
        ...
        Handler = 'lambda_start_function.lambda_handler' #which func for lambda file.def
    )
